...
** Author: Philip Chang
** Date: June 13, 2017
** Description: CS475 - Project #7a - OpenCL / OpenGL Particle System
** from http://web.engr.oregonstate.edu/~mjb/cs575/Projects/proj07a.html
*********************************************************************************************/
#include <stdio.h>
#include <math.h>
#include <string.h>
...
const char *WINDOWTITLE = { "OpenCL/OpenGL Particle System -- Philip Chang" };
...
const int NUM_PARTICLES = 1024*32; //1024*1024
const int LOCAL_SIZE    = 32;
const char *CL_FILE_NAME   = { "changp.cl" };
...
const char *CL_BINARY_NAME = { "changp.nv" };
...
Display( )
{
	...
	{
		char str[128];
		sprintf( str, "Frame %8d -- %6.1f MegaParticles/Sec", Frame, (float)NUM_PARTICLES/ElapsedTime/1000000. );
...
{
        char filename[128];
        sprintf( filename, "changp.%03d.particles", Frame ); // use your engr login instead
