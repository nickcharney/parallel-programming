...
** Author: Philip Chang
** Date: June 2, 2017
** Description: CS475 - Project #6 - OpenCL Array Multiply, Multiply-Add, and Multiply-Reduce
** from http://web.engr.oregonstate.edu/~mjb/cs575/Projects/proj06.html
*********************************************************************************************/
//THIRD - Array Multiply-Reduce
//from discussion 8
//status = clSetKernelArg( kernel, 2, sizeof(float), NULL ); //errors

//proper set up for workgroup specific prods array is
...
main( int argc, char *argv[ ] )
{
	...
	status = clSetKernelArg( kernel, 2, (int)LOCAL_SIZE * sizeof(float), NULL ); // local “prods” array – one per work-item
	if( status != CL_SUCCESS )
		fprintf( stderr, "clSetKernelArg failed (2)\n" );
